    ...
    ?>
            ...
            <div id="tabs">
                <ul>
                    ...
                    <li><a href="#tabs-track"><?php _e('DO NOT TRACK', 'e-mailit') ?></a></li>
                </ul>
                <div id="tabs-share_buttons">
                    ...
                    <div class="emailit_admin_panel_section">
                        ...
                        <ul class="fields">
                            ...
                            <li>
                                <label><?php _e('SIZE', 'e-mailit') ?></label>
                            ...
                            <li>
                                ...
                                <div class="colorpicker_widget">
                                    <input type="text" name="emailit_options[headline_color]" maxlength="7" size="7" value="<?php echo $emailit_options["headline_color"] ?>"/>
                                </div>
                            </li>
                        </ul>
                    </div>					
                ...
                <div id="tabs-advanced">
                    <ul class="fields">
                        ...
                        <li>
                            <label><?php _e('SHOW AFTER SHARE PROMO DIALOG', 'e-mailit') ?> (<a href="http://blog.e-mailit.com/2015/12/monetize-your-content-marketing.html" target="_blank">what's this?</a>)</label>
                        ...
                        <li>
                            <label><a href="https://www.e-mailit.com/sample/ad-unit.html" target="_blank" download>Download</a> <?php _e(' and insert your Ad Unit location', 'e-mailit') ?> </label>
                            <input placeholder="http://" name="emailit_options[ad_url]" type="text" value="<?php echo $emailit_options["ad_url"] ?>">
                        </li>                        
                        <li>
                            <label><?php _e('YOUR HEADING MESSAGE', 'e-mailit') ?></label>
                            <label><?php _e('This text will appear above the follow buttons', 'e-mailit') ?></label>
